...
class Phonebook:
    ...
    def update_contact(self, surname,name):
        ...
        for i in self.contacts: #scansiona in cerca del cognome
            if i["_Contact__surname"].casefold() == surname.casefold()  and i["_Contact__name"].casefold() == name.casefold() :
    ...
    def delete_contact(self):
        ...
        name= input("Nome: ")
        for contact in self.contacts:
            if  contact["_Contact__surname"].casefold() == surname.casefold() and contact["_Contact__name"].casefold() == name.casefold():
    ...
    def search_contact_by_name(self):
        ...
        for contact in self.contacts:
            if contact["_Contact__name"].casefold() == search.casefold():
    ...
    def search_contact(self):
        ...
        for contact in self.contacts:
            if contact["_Contact__surname"].casefold() == search.casefold():
                print(f"Contatto trovato ! cognome: {contact['_Contact__surname']},name: {contact['_Contact__name']}, telefono: {contact['_Contact__phone']}")
                print()
                found = 1
